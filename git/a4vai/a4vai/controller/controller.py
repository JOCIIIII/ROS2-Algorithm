...
class ControllerNode(Node):
    ...
    def initializeParameter(self):
        ...
        # self.log_state = open('~/px4_ros_ws/src/a4vai/a4vai/logFolder/State.py', 'w')
        # self.log_state.close()

        # self.log_wapoint = open('~/px4_ros_ws/src/a4vai/a4vai/logFolder/Waypoint.py', 'w')
...
#################################################################################################################
    ...
    def VehicleLocalPositionSetpointCallback(self, SetPosition, SetVelocity, SetYaw):
        ...
        msg.velocity = [SetVelocity[0], SetVelocity[1], SetVelocity[2]]
        msg.yaw = np.NaN
        msg.yawspeed = SetYaw
